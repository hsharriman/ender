...
function aasSideTouchesOneAngleEach(
  segLeft: string,
  c1: string,
  c2: string,
): boolean {
...
export function checkIsosceles(
  conSeg: Stmt,
  isoscelesStmt: Stmt,
  ctx: ProofContent,
): TriangleReasonResult {
